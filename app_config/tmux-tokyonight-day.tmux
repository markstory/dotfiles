...
set -g status-left "#[bg=#2e7de9]#[fg=#e9e9ed]#{?client_prefix,  ,   }#[fg=#2e7de9,bg=#d4d6e4,nobold,nounderscore,noitalics]"
...
setw -g window-status-current-format "#[fg=#d4d6e4,bg=#a8aecb,nobold,nounderscore,noitalics]#[fg=#2e7de9,bg=#a8aecb,bold] #I #W #[fg=#a8aecb,bg=#d4d6e4,nobold,nounderscore,noitalics]"
