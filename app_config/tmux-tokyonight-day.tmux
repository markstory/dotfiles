...
set -g status-left "#[fg=#e9e9ed,nobold,nounderscore,noitalics]#[bg=#d4d6e4]#{?client_prefix,#[fg=#41a6b5],#[fg=#2e7de9]} "
...
setw -g window-status-current-format "#[bg=#d4d6e4,fg=#a8aecb,nobold,nounderscore,noitalics]#[fg=#e9e9ed,bg=#a8aecb]#I #W#[fg=#a8aecb,bg=#d4d6e4,nobold,nounderscore,noitalics]"
