...
set -g status-left "#[fg=#e9e9ed,nobold,nounderscore,noitalics]#{?client_prefix,#[bg=#587539],#[bg=#2e7de9]} #[bg=#d4d6e4]#{?client_prefix,#[fg=#587539],#[fg=#2e7de9]}"
...
setw -g window-status-format "#[fg=#d4d6e4,bg=#d4d6e4,nobold,nounderscore,noitalics]#[default] #I #W#[fg=#d4d6e4,bg=#d4d6e4,nobold,nounderscore,noitalics] "
setw -g window-status-current-format "#[bg=#d4d6e4,fg=#a8aecb,nobold,nounderscore,noitalics]#[fg=#2e7de9,bg=#a8aecb]#I #W#[fg=#a8aecb,bg=#d4d6e4,nobold,nounderscore,noitalics]"
