...
set -g status-right "#[fg=#2e7de9,bg=#eef1f4] #{prefix_highlight} #[fg=#dde2e7,bg=#eef1f4,nobold,nounderscore,noitalics]#[fg=#5079be,bg=#dde2e7] %Y-%m-%d %I:%M %p #[fg=#5079be,bg=#dde2e7,nobold,nounderscore,noitalics]#[fg=#dde2e7,bg=#5079be,nobold] #h "

setw -g window-status-activity-style "underscore,fg=#6172b0,bg=#d4d6e4"
setw -g window-status-separator ""
setw -g window-status-style "NONE,fg=#bcc5cf,bg=#eef1f4"
setw -g window-status-format "#[fg=#bcc5cf,bg=#eef1f4,nobold,nounderscore,noitalics]#[default] #I #W #[fg=#bcc5cf,bg=#eef1f4,nobold,nounderscore,noitalics] "
