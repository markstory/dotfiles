...
set -g status-right "#[fg=#2e7de9,bg=#eef1f4] #{prefix_highlight} #[fg=#dde2e7,bg=#eef1f4,nobold,nounderscore,noitalics]#[fg=#8790a0,bg=#dde2e7] %Y-%m-%d %I:%M %p "

# Make inactive panes darker so the active one is easier to find
set -g window-style "bg=#fbfbfb"
set -g window-active-style "bg=#fefefe"
...
setw -g window-status-current-format "#[bg=#eef1f4,fg=#3a8b84,nobold,nounderscore,noitalics]#[fg=#fafafa,bg=#3a8b84]#I#[bg=#dde2e7,fg=#3a8b84,nobold,nounderscore,noitalics]#[fg=#3a8b84,bg=#dde2e7,nobold,nounderscore,noitalics] #W #[fg=#dde2e7,bg=#eef1f4]"
